...
<body data-new-gr-c-s-check-loaded="14.1163.0" data-gr-ext-installed="" cz-shortcut-listen="true">
    ...
    <section class="py-5 text-center container">
      <div class="row py-lg-5">
        <div class="col-lg-6 col-md-8 mx-auto">
          ...
          <p>
          <form id="crud-form" method="post" action="php\add.php">
            <div class="form-group">
              <label for="jumlah_transaksi">Jumlah Transaksi</label>
              <input type="text" class="form-control" id="jumlah_transaksi" placeholder="Enter Jumlah Transaksi">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" id="deskripsi_transaksi" rows="3" placeholder="Enter Deskripsi Transaksi"></textarea>
            </div>
            <div class="form-group">
  ...
  <footer class="text-body-secondary py-5">
    <div class="container">
      ...
      <p class="mb-0">New to Bootstrap? <a href="http://localhost/">Visit the homepage</a> or read our <a href="http://localhost/moneycord/getting-started/introduction/">getting started guide</a>.</p>
    </div>
  </footer>
